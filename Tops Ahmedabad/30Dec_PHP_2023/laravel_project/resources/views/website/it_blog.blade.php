      ...
      <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 pull-right">
        <div class="full">
          <div class="blog_section">
            <div class="blog_feature_img"> <img class="img-responsive" src="{{ url('website/images/it_service/post-06.jpg')}}" alt="#"> </div>
            <div class="blog_feature_cantant">
              ...
              <div class="bottom_info">
                <div class="pull-left"><a class="btn sqaure_bt" href="it_blog_detail.php">Read More<i class="fa fa-angle-right"></i></a></div>
          ...
          <div class="blog_section">
            <div class="blog_feature_img"> <img class="img-responsive" src="{{ url('website/images/it_service/post-08.jpg')}}" alt="#"> </div>
            <div class="blog_feature_cantant">
              <p class="blog_head">Blogpost With Image</p>
              <div class="post_info">
                <ul>
          ...
          <div class="blog_section">
            <div class="blog_feature_img"> <img class="img-responsive" src="{{ url('website/images/it_service/home_01.png')}}" alt="#"> </div>
            <div class="blog_feature_cantant">
              <p class="blog_head">Blogpost With Image</p>
              <div class="post_info">
                <ul>
          ...
          <div class="center">
            <ul class="pagination style_1">
              ...
              <li><a href="it_blog_grid.php">2</a></li>
