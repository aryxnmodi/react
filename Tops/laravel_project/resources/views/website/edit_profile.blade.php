                ...
                <form class="form_contant" action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
					<div class="field col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <input class="field_custom" name="name" placeholder="Name" value="<?php echo $fetch->name;?>" type="text" required />
                    </div>
                    <div class="field col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <input class="field_custom" name="email" placeholder="Email adress"  value="<?php echo $fetch->email;?>" type="email" required />
                    </div>
					...
					<div class="field col-lg-12 col-md-12 col-sm-12 col-xs-12">
					  ...
					  <img src="{{ url('website/images/customer/<?php echo $fetch->file;?>" width="50px"/>
                    </div>
					...
					<div class="field col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-5">
					 ...
					 <div class="field col-lg-6 col-md-6 col-sm-12 col-xs-12">
						<div><input type="submit" name="submit" class="btn main_bt" value="Save" /></div>
					</div>
